...
class ExerciseSetsControllerTest < ActionDispatch::IntegrationTest
  ...
  test "should create exercise_set" do
    assert_difference('ExerciseSet.count') do
      post exercise_sets_url, params: { exercise_set: { repetitions: @exercise_set.repetitions, weight: @exercise_set.weight } }, as: :json
    end
  ...
  test "should update exercise_set" do
    patch exercise_set_url(@exercise_set), params: { exercise_set: { repetitions: @exercise_set.repetitions, weight: @exercise_set.weight } }, as: :json
    assert_response 200
  end
